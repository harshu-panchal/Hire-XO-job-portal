          ...
          <form onSubmit={handleSubmit}>
            ...
            {currentStep === 3 && (
              <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                <div className="space-y-1.5">
                  ...
                  {cvFile && (
                    <p className="text-xs text-green-600 font-bold ml-1 flex items-center gap-1">
                      <Check className="size-3" /> {cvFile.name}
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  {photoFile && (
                    <p className="text-xs text-green-600 font-bold ml-1 flex items-center gap-1">
                      <Check className="size-3" /> {photoFile.name}
                    </p>
                  )}
                </div>
            ...
            <div className="mt-8 flex gap-3">
              {currentStep < totalSteps ? (
                <Button
                  type="button"
                  onClick={handleNext}
                  className="w-full h-14 rounded-2xl text-base font-bold tracking-wide bg-gradient-to-r from-violet-500 to-purple-600 hover:opacity-90 transition-all shadow-lg shadow-primary/20 hover:shadow-primary/30 active:scale-[0.98]"
                >
                  Next Step
                </Button>
              ) : (
            ...
            <div className="text-center pt-2 mt-4">
              <p className="text-sm font-medium text-slate-500">
                ...
                <Link to="/login/employee" className="text-primary font-bold hover:underline">
                  Login
                </Link>
              </p>
            </div>
