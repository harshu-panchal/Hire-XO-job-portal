...
const ResourceSignup = () => {
  ...
  const resourceCategory: ResourceCategory = (
    category ? category.charAt(0).toUpperCase() + category.slice(1) : "Tenders"
  ) as ResourceCategory;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const signupData: ResourceSignupData = {
        ...
        investmentSector:
          formData.investmentSector.length > 0 ? formData.investmentSector : undefined,
