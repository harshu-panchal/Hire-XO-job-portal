...
const Settings = () => {
    ...
    const [form, setForm] = useState({
        ...
        experience: Array.isArray(userProfile?.profile?.experience) ? userProfile.profile.experience : [],
    });
                ...
                <div className="flex flex-col items-center gap-4">
                    <div className="relative">
                        <div className="size-28 rounded-full border-4 border-white dark:border-slate-800 shadow-xl overflow-hidden">
                            <img
                                src={userProfile?.profilePhoto || `https://api.dicebear.com/7.x/avataaars/svg?seed=${userProfile?.name}`}
                                alt="Profile"
                        ...
                        <div className="space-y-4 pt-2">
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    onClick={() => setForm(f => ({
                                        ...f,
                                        experience: [...(Array.isArray(f.experience) ? f.experience : []), { company: "", role: "", period: "" }]
                                    }))}
                            ...
                            {Array.isArray(form.experience) && form.experience.map((exp: any, index: number) => (
