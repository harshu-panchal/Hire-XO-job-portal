                            ...
                            <Card key={post._id} className="p-5 border-slate-200 hover:shadow-md transition-shadow">
                                ...
                                <div className="flex items-center gap-4 border-t border-slate-100 pt-4">
                                    <button
                                        ...
                                        className={`flex items-center gap-2 transition-colors group ${post.likes.includes(user?.id || '') ? 'text-rose-500' : 'text-slate-500 hover:text-rose-500'}`}
                                        disabled={isLoading}
                                    >
                                        <Heart className={`w-5 h-5 group-hover:scale-110 transition-transform ${post.likes.includes(user?.id || '') ? 'fill-current' : ''}`} />
