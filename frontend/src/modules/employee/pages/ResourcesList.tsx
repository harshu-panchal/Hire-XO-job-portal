...
import ResourceCard from "@/modules/employee/components/ResourceCard";
import ResourceCategoryFilter from "@/modules/employee/components/ResourceCategoryFilter";
  ...
  return (
    <div className="py-6 space-y-8 select-none">
      ...
      <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-black tracking-tight">
                  {resources.filter((r) => r.category === "Tenders").length}+
                </p>
              </div>
            </div>
        ...
        {/* Category Filter */}
        <ResourceCategoryFilter activeCategory={filters.type as any} onCategoryChange={setType} />
      </div>
