import { MapPin, Clock, Briefcase, Building2, Bookmark, DollarSign } from "lucide-react";
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div
                className={`inline-flex items-center px-2 py-0.5 rounded-md ${colors.bg} ${colors.border} border mt-0.5`}
              >
