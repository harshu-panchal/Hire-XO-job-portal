...
const readyToInvestData: InvestorItem[] = [
  ...
  },
  {
    id: "2",
    name: "Growth Equity",
    description: "Focused on manufacturing startups",
    location: "Delhi, NCR",
    contact: "+91 87654 32109",
    email: "info@growth.com",
    budget: "₹10 Cr+",
    status: "Active",
  },
  {
    id: "3",
    name: "Angel Network",
    description: "Group of private angel investors",
...
const needInvestmentData: SeekerItem[] = [
  {
    ...
    description: "Seed funding for AI platform expansion",
    location: "Pune, MH",
  ...
  },
  {
    ...
    description: "Series A for green materials unit",
    location: "Hyderabad, TS",
    contact: "+91 88776 65544",
    email: "ceo@buildinfra.com",
    amountNeeded: "₹15 Cr",
    status: "Active",
  },
  {
    ...
    name: "AgriTech One",
    title: "Smart Farming",
    description: "Pre-seed for drone technology",
    location: "Nagpur, MH",
  ...
  const handleSave = () => {
    if (activeTab === "invest") {
      ...
      if (editingItem) {
        setInvestors(
          investors.map((i) =>
            i.id === editingItem.id ? ({ ...i, ...investForm } as InvestorItem) : i
          )
        );
      } else {
      ...
      if (!seekForm.name || !seekForm.title || !seekForm.amountNeeded)
        return alert("Startup Name, Title and Amount are required");

      if (editingItem) {
        setSeekers(
          seekers.map((s) => (s.id === editingItem.id ? ({ ...s, ...seekForm } as SeekerItem) : s))
        );
      } else {
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <span
                className={`px-2.5 py-1 rounded-full text-xs font-medium ${
                  item.status === "Active" || item.status === "Funded"
