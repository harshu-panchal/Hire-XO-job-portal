        ...
        >
          ...
          <div className="space-y-4">
            {recentActivity.map((item) => (
              <div
                key={item.id}
                className="flex items-start gap-3 pb-4 border-b border-slate-100 dark:border-white/5 last:border-0 last:pb-0"
              >
                ...
                <span className="text-xs text-slate-400 dark:text-white/40 whitespace-nowrap">
                  {item.time}
                </span>
              </div>
            ))}
