...
import { User, Bell, Shield, Palette, Globe, Save, ChevronRight, Upload, Check, Lock, Eye, EyeOff } from "lucide-react";
...
function ProfileSettings() {
    ...
    const [profileImage, setProfileImage] = useState<string | null>(user?.profile?.profilePhoto || null);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label className="block text-sm font-medium text-slate-700 dark:text-white/70 mb-1.5">Username</label>
                    <input
                        type="text"
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                {saved && (
                    <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-green-500 text-xs font-medium flex items-center gap-1">
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                <div className="p-4 bg-slate-50 dark:bg-white/5 rounded-xl border border-slate-200 dark:border-white/10">
                    ...
                    {showPasswordForm && (
                        <form onSubmit={handlePasswordChange} className="mt-4 pt-4 border-t border-slate-200 dark:border-white/10 space-y-4 animate-in fade-in slide-in-from-top-2">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="relative">
                                    <label className="block text-sm font-medium text-slate-700 dark:text-white/70 mb-1.5">Current Password</label>
                                    <div className="relative">
                                ...
                                <div className="relative">
                                    <label className="block text-sm font-medium text-slate-700 dark:text-white/70 mb-1.5">New Password</label>
                                    <div className="relative">
                                        <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400" />
                                        <input
                            ...
                            <div className="flex justify-end gap-3 items-center">
                                {saved && <span className="text-green-500 text-sm font-medium">Password updated!</span>}
                                <button
                                    type="submit"
                                    disabled={isSaving}
            ...
            <div>
                ...
                <div className="grid grid-cols-3 gap-4">
                    {themes.map((t) => (
                        ...
                        >
                            <span className={`font-semibold text-sm ${theme === t.id ? 'text-primary' : 'text-slate-600 dark:text-white/60'}`}>
                                {t.label}
                            </span>
                        </button>
                    ))}
...
function GeneralSettings() {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex justify-end pt-4 gap-3 items-center">
                {saved && (
                    <motion.span initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} className="text-green-500 text-sm font-medium flex items-center gap-1">
