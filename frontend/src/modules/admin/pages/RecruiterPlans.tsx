...
import { Plus, Edit2, Trash2, X, Check, CreditCard, Briefcase, Star, TrendingUp } from "lucide-react";
...
const initialPlans: Plan[] = [
    ...
    },
    {
        ...
        price: 4999,
        duration: "month",
        features: ["50 Job Posts", "Advanced Analytics", "Priority Support", "Candidate Filtering"],
        isPopular: true,
        subscribers: 820
    },
    {
        ...
        price: 9999,
        duration: "month",
        features: ["Unlimited Posts", "Custom Branding", "Dedicated Manager", "API Access", "ATS Integration"],
        isPopular: false,
        subscribers: 180
    },
];
    ...
    return (
        ...
        >
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-semibold text-slate-900 dark:text-white">Recruiter Plans</h1>
                    <p className="text-slate-500 dark:text-white/60 mt-1">Manage subscription plans for recruiters</p>
                </div>
                <button
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-white/10 p-5">
                    ...
                    <p className="text-sm text-slate-500 dark:text-white/50 mt-1">Total Recruiters</p>
                </div>
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-white/10 p-5">
                    <div className="flex items-center gap-3 mb-3">
                    ...
                    >
                        ...
                        <div className="text-center mb-6">
                            ...
                            <p className="text-sm text-slate-500 dark:text-white/50 mt-2">
                                {plan.subscribers.toLocaleString()} recruiters
                            </p>
                        </div>
