...
const MachineDetails = () => {
  ...
  const machine = {
    ...
    description:
      "Excellent working condition CP30 batching plant. Regularly serviced by authorized dealers. Includes all standard attachments and a 6-month limited warranty on the hydraulic system.",
    specs: [
