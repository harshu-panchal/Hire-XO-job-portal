                ...
                <div className="bg-white dark:bg-slate-900/50 rounded-[3rem] p-8 pt-16 border border-slate-200 dark:border-white/10 text-center shadow-sm">
                    ...
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-0">
                        <div className="relative">
                            <div className="size-24 rounded-[2rem] bg-indigo-600 flex items-center justify-center text-white text-3xl font-black shadow-xl border-4 border-slate-50 dark:border-background">
                                JD
                            </div>
                    ...
                    <p className="text-indigo-600 font-black uppercase tracking-widest text-[10px] mb-6">Premium Client</p>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8">
                        <div className="bg-slate-50 dark:bg-white/5 p-4 rounded-3xl text-center">
                            ...
                            <p className="text-base font-black italic">12</p>
                        </div>
                        <div className="bg-slate-50 dark:bg-white/5 p-4 rounded-3xl text-center">
                            <p className="text-[8px] font-black uppercase tracking-widest text-slate-400 mb-0.5">Spent</p>
                            <p className="text-base font-black italic">₹45L</p>
                        </div>
                    </div>
