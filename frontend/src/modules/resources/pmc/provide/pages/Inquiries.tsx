    ...
    const inquiries = [
        {
            ...
            message: "Looking for PMC for an upcoming project in Sector 21. Need risk audit too.",
            time: "1h ago",
            status: "New",
            initial: "JD",
        ...
        },
        {
            id: 2,
            name: "Sunita Mehta",
            role: "Govt Contractor",
            message: "Need quote for highway project planning and design review.",
            time: "4h ago",
            status: "Replied",
            initial: "SM",
