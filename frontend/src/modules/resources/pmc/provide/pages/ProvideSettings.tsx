            ...
            <div className="space-y-8">
                ...
                <div className="pt-4">
                    <button
                        ...
                        className="w-full h-20 rounded-[3rem] bg-indigo-600/5 text-slate-400 font-black text-[11px] uppercase tracking-[0.3em] flex items-center justify-center gap-3 active:scale-[0.98] transition-all border border-slate-200 dark:border-white/10 hover:bg-red-500 hover:text-white hover:border-red-500 group"
                    >
