...
const ProvideProfile = () => {
  ...
  const initial = (profileAny.company || user.name || "P").charAt(0).toUpperCase();
        ...
        <div className="bg-white rounded-[3rem] p-8 pt-16 border border-slate-200 text-center shadow-sm">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-0">
            <div className="relative">
              <div className="size-24 rounded-[2rem] bg-indigo-600 flex items-center justify-center text-white text-3xl font-black shadow-xl border-4 border-slate-50 italic">
                {initial}
              </div>
              <button
          ...
          <p className="text-indigo-600 font-black uppercase tracking-widest text-[9px] mb-6 italic">
            Verified PMC Firm • ISO 9001
          </p>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            ...
            <div className="bg-slate-50 p-4 rounded-3xl text-center border border-slate-100">
              ...
              <p className="text-base font-black italic">{profileAny.successRate || "N/A"}</p>
            </div>
          </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-3">
          ...
          >
            ...
            <Edit3 className="size-5 text-slate-300 group-hover:text-indigo-600 transition-colors" />
          </button>
        </div>
      </div>
    </div>
