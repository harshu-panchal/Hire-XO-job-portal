                            ...
                            >
                                <div className="flex items-start justify-between mb-3">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className="text-lg font-black text-emerald-600">₹{opp.amount || opp.seekingAmount || "Negotiable"}</p>
                                    </div>
                                </div>
            ...
            <div className="space-y-3 pb-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                        ...
                        <p className="text-[9px] font-black uppercase tracking-widest opacity-80">Track Interests</p>
                    </Link>
                </div>
            </div>
        </div>
