...
import { ChevronLeft, Bell, TrendingUp, Info, CheckCircle, Clock, Trash2 } from "lucide-react";
...
const initialNotifications: Notification[] = [
    ...
    },
    {
        ...
        description: "Your quarterly dividend of ₹12,400 from AgroCorp has been credited.",
        time: "2d ago",
        type: 'success',
        unread: false,
    }
...
const InvestorBrowseNotifications = () => {
    ...
    const getIcon = (type: string) => {
        switch (type) {
            case 'success': return <TrendingUp className="size-5" />;
...
export default InvestorBrowseNotifications;
