    ...
    return (
      <div className="py-20 text-center space-y-4">
        ...
        <Link
          ...
          className="text-violet-600 font-black uppercase tracking-widest text-xs"
        >
          Return to list
        </Link>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-slate-900 text-white rounded-[2.5rem] p-8 shadow-xl shadow-slate-900/10">
            ...
            <p className="text-[10px] font-black uppercase tracking-[0.2em] mb-6 opacity-60">
            ...
            <p className="text-[8px] font-black uppercase text-center mt-4 opacity-40">
              Verified enterprise listing
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-[2.5rem] p-8 space-y-6">
            ...
            <div className="space-y-3">
              ...
              {!user && (
                <p className="text-[8px] font-black uppercase text-center text-slate-400">
      ...
      <div className="py-8 flex flex-col items-center justify-center gap-4">
        <div className="flex items-center gap-2 px-6 py-3 rounded-2xl bg-emerald-500/5 border border-emerald-500/10">
          ...
          <span className="text-[10px] font-black uppercase tracking-widest text-emerald-600">
            Enterprise Verified Opportunity
          </span>
        </div>
        <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest max-w-sm text-center leading-relaxed">
          This opportunity has been manually reviewed by our compliance team. Investors are advised
