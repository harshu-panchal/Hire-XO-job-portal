import { Bell, Lock, Moon, Sun, Globe, HelpCircle, LogOut, ChevronRight, Shield, CreditCard, Eye, X, Check } from "lucide-react";
        ...
        <div className="py-6 space-y-6 select-none">
            ...
            <div className="bg-white dark:bg-slate-900/50 rounded-[2rem] p-6 border border-slate-200 dark:border-white/10">
                ...
                >
                    ...
                    <div className={`px-3 py-1 rounded-full text-xs font-black ${isDarkMode ? "bg-primary/10 text-primary" : "bg-amber-500/10 text-amber-600"}`}>
                        {isDarkMode ? "ON" : "OFF"}
                    </div>
                </button>
            </div>
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 max-w-md w-full border border-slate-200 dark:border-white/10 shadow-2xl">
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="text-xs font-black uppercase tracking-widest text-slate-500 mb-2 block">Current Password</label>
                                <input
                                    type="password"
                            ...
                            <div>
                                <label className="text-xs font-black uppercase tracking-widest text-slate-500 mb-2 block">New Password</label>
                                <input
                                    type="password"
                                    value={newPassword}
                            ...
                            <div>
                                <label className="text-xs font-black uppercase tracking-widest text-slate-500 mb-2 block">Confirm Password</label>
                                <input
                                    type="password"
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 max-w-md w-full border border-slate-200 dark:border-white/10 shadow-2xl">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-purple-50 dark:bg-purple-950/20 rounded-2xl border border-purple-200 dark:border-purple-900">
                                ...
                                <p className="text-xs text-slate-600 dark:text-slate-400">Visit our comprehensive help center for FAQs and guides</p>
                            </div>
                        </div>
                        <button
                            onClick={() => setShowHelpModal(false)}
