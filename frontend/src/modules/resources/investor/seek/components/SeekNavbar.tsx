...
export const SeekNavbar = () => {
    ...
    const [notifications, setNotifications] = useState([
        ...
        },
        {
            ...
            message: "Your telemedicine platform looks promising. I have experience in healthcare tech...",
            timestamp: "1 day ago",
            isRead: true,
        },
    ]);
                            ...
                            {notifications.length === 0 ? (
                                ...
                                notifications.map((notification) => (
                                    <div
                                        ...
                                        className={`p-4 border-b border-slate-200 dark:border-white/10 cursor-pointer transition-all hover:bg-slate-50 dark:hover:bg-slate-800/50 ${!notification.isRead ? "bg-primary/5" : ""
                                            }`}
                                    >
                                        <div className="flex items-start gap-3">
                                            <div className={`size-10 rounded-lg bg-gradient-to-br ${notification.investorGradient} flex items-center justify-center text-white font-black text-xs shrink-0`}>
