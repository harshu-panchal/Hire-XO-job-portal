                  ...
                  {notifications.length === 0 ? (
                    ...
                    notifications.map((notification) => (
                      <button
                        ...
                        className={`w-full p-4 text-left hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors border-b border-slate-100 dark:border-white/5 last:border-0 ${
