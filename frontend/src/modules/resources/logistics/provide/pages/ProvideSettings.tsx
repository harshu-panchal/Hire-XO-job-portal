    ...
    return (
        <div className="py-6 space-y-10 select-none">
            ...
            <div className="space-y-8">
                        ...
                        <div className="divide-y divide-slate-100 dark:divide-white/5">
                            <button className="w-full flex items-center justify-between p-7 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group">
                                ...
                                <div className="flex items-center gap-3">
                                    <span className="text-[9px] font-black text-orange-600 uppercase tracking-widest italic">Always</span>
                    ...
                    <div className="bg-white dark:bg-slate-900/50 rounded-[3rem] border border-slate-200 dark:border-white/10 overflow-hidden shadow-sm">
                        <div className="divide-y divide-slate-100 dark:divide-white/5">
                            ...
                            <button className="w-full flex items-center justify-between p-7 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group">
                                ...
                                <div className="flex items-center gap-3">
                                    <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest italic">08 Active</span>
                                    <ChevronRight className="size-5 text-slate-300 group-hover:text-orange-600 transition-colors" />
                                </div>
                            </button>
                        </div>
                ...
                {/* Danger Zone */}
                <div className="pt-4">
                    <button className="w-full h-20 rounded-[3rem] bg-orange-600/5 text-slate-400 font-black text-[11px] uppercase tracking-[0.3em] flex items-center justify-center gap-3 active:scale-[0.98] transition-all border border-slate-200 dark:border-white/10 hover:bg-red-500 hover:text-white hover:border-red-500 group">
