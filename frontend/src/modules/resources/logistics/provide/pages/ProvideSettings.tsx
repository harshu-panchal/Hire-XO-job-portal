...
import { Bell, Lock, Smartphone, Globe, LogOut, ChevronRight, X, Check, Eye, EyeOff, Trash2, AlertCircle } from "lucide-react";
...
const ProvideSettings = () => {
    ...
    const [devices, setDevices] = useState<Device[]>([
        { id: 1, name: "Truck 01 - MH12AB1234", driver: "Rajesh Kumar", lastActive: "2 mins ago", status: "Active" },
        { id: 2, name: "Truck 02 - MH12CD5678", driver: "Amit Sharma", lastActive: "15 mins ago", status: "Active" },
        { id: 3, name: "Truck 03 - MH12EF9012", driver: "Suresh Patil", lastActive: "1 hour ago", status: "Active" },
        { id: 4, name: "Truck 04 - MH12GH3456", driver: "Vijay Singh", lastActive: "3 hours ago", status: "Active" },
        { id: 5, name: "Truck 05 - MH12IJ7890", driver: "Prakash Yadav", lastActive: "5 hours ago", status: "Active" },
        { id: 6, name: "Truck 06 - MH12KL2345", driver: "Ramesh Gupta", lastActive: "1 day ago", status: "Inactive" },
        { id: 7, name: "Truck 07 - MH12MN6789", driver: "Anil Desai", lastActive: "2 days ago", status: "Inactive" },
        { id: 8, name: "Truck 08 - MH12OP0123", driver: "Manoj Verma", lastActive: "3 days ago", status: "Inactive" }
    ]);
            ...
            <div className="space-y-8">
                        ...
                        <div className="divide-y divide-slate-100 dark:divide-white/5">
                            ...
                            >
                                <div className="flex items-center gap-5">
                                    ...
                                    <p className="font-black text-[11px] uppercase tracking-widest text-left">Admin Password</p>
                                </div>
                                <ChevronRight className="size-5 text-slate-300 group-hover:text-orange-600 transition-colors" />
                            </button>
                            ...
                            >
                                <div className="flex items-center gap-5">
                                    ...
                                    <p className="font-black text-[11px] uppercase tracking-widest text-left">Fleet Devices</p>
                                </div>
                                <div className="flex items-center gap-3">
                ...
                <div className="pt-4">
                    <button
                        ...
                        className="w-full h-20 rounded-[3rem] bg-orange-600/5 text-slate-400 font-black text-[11px] uppercase tracking-[0.3em] flex items-center justify-center gap-3 active:scale-[0.98] transition-all border border-slate-200 dark:border-white/10 hover:bg-red-500 hover:text-white hover:border-red-500 group"
                    >
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl">
                                ...
                                <button
                                    ...
                                    className={`relative w-14 h-7 rounded-full transition-colors ${leadAlerts ? "bg-orange-600" : "bg-slate-300 dark:bg-slate-600"}`}
                                >
                                    <div className={`absolute top-1 left-1 size-5 rounded-full bg-white transition-transform ${leadAlerts ? "translate-x-7" : ""}`} />
                                </button>
                            </div>
                            ...
                            <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl">
                                ...
                                <button
                                    ...
                                    className={`relative w-14 h-7 rounded-full transition-colors ${emailNotifications ? "bg-orange-600" : "bg-slate-300 dark:bg-slate-600"}`}
                                >
                                    <div className={`absolute top-1 left-1 size-5 rounded-full bg-white transition-transform ${emailNotifications ? "translate-x-7" : ""}`} />
                                </button>
                            </div>
                            ...
                            <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl">
                                ...
                                <button
                                    ...
                                    className={`relative w-14 h-7 rounded-full transition-colors ${pushNotifications ? "bg-orange-600" : "bg-slate-300 dark:bg-slate-600"}`}
                                >
                                    <div className={`absolute top-1 left-1 size-5 rounded-full bg-white transition-transform ${pushNotifications ? "translate-x-7" : ""}`} />
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="p-4 bg-emerald-50 dark:bg-emerald-950/20 rounded-2xl border border-emerald-200 dark:border-emerald-900">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <p className="text-sm font-black text-emerald-900 dark:text-emerald-100">Public Listing Status</p>
                                </div>
                            ...
                            <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl">
                                ...
                                <button
                                    ...
                                    className={`relative w-14 h-7 rounded-full transition-colors ${isPubliclyListed ? "bg-emerald-600" : "bg-slate-300 dark:bg-slate-600"}`}
                                >
                                    <div className={`absolute top-1 left-1 size-5 rounded-full bg-white transition-transform ${isPubliclyListed ? "translate-x-7" : ""}`} />
                                </button>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handlePasswordChange} className="space-y-4">
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        required
                                        className="w-full px-4 py-3 pr-12 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-white/10 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-amber-600/20 transition-all"
                                    />
                                    <button
                                        type="button"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-white/10 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-amber-600/20 transition-all"
                                />
                            </div>
                    ...
                    <div onClick={(e) => e.stopPropagation()} className="bg-white dark:bg-slate-900 rounded-3xl p-6 max-w-2xl w-full border border-slate-200 dark:border-white/10 shadow-2xl max-h-[85vh] overflow-y-auto">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-xs text-slate-500 mt-1">{activeDevicesCount} active • {devices.length - activeDevicesCount} inactive</p>
                            </div>
                            <button
                        ...
                        <div className="space-y-3">
                            {devices.map((device) => (
                                <div key={device.id} className="p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <div className={`size-12 rounded-xl flex items-center justify-center ${device.status === "Active" ? "bg-emerald-500/10 text-emerald-600" : "bg-slate-300/10 text-slate-400"}`}>
                                            <Smartphone className="size-5" />
                                        </div>
                                        <div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <span className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest ${device.status === "Active" ? "bg-emerald-500/10 text-emerald-600" : "bg-slate-300/10 text-slate-500"}`}>
                                            {device.status}
                                        </span>
                                        <button
