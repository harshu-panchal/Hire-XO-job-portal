        ...
        <div className="py-6 space-y-8 select-none">
            ...
            <div className="relative pt-12">
                <div className="bg-white dark:bg-slate-900/50 rounded-[3rem] p-8 pt-16 border border-slate-200 dark:border-white/10 text-center shadow-sm">
                    ...
                    <p className="text-orange-600 font-black uppercase tracking-widest text-[9px] mb-6 italic">Verified Fleet Owner • Pan India</p>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8">
                        ...
                        <div className="bg-slate-50 dark:bg-white/5 p-4 rounded-3xl text-center border border-slate-100 dark:border-white/5">
                            <p className="text-[8px] font-black uppercase tracking-widest text-slate-400 mb-0.5">Trips</p>
                    ...
                    <div className="space-y-4 text-left">
                        ...
                        <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5">
                            ...
                            <div>
                                <p className="text-[8px] font-black uppercase tracking-widest text-slate-400">Fleet ID</p>
                                <p className="text-[11px] font-black uppercase tracking-tighter">LOG-MUM-2026-F12</p>
                            </div>
                        </div>
                    </div>
                </div>
