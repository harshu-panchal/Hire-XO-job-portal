...
const BrowseSettings = () => {
  ...
  useEffect(() => {
    ...
    setNotifications(prefs.logisticsBrowseNotifications ?? true);
    setIs2faEnabled(prefs.logisticsBrowse2FA ?? true);
  ...
  const handleNotificationsToggle = async () => {
    ...
    const ok = await persistSettings({ logisticsBrowseNotifications: next });
  ...
  const handle2faToggle = async () => {
    ...
    const ok = await persistSettings({ logisticsBrowse2FA: next });
