        ...
        <div className="py-6 space-y-8 select-none">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="bg-red-600 p-6 rounded-[2.5rem] text-white">
                    ...
                    <p className="text-[9px] font-black uppercase tracking-widest opacity-80">Active Shipments</p>
                </div>
            ...
            <div className="space-y-4">
                <h2 className="text-xl font-black tracking-tight px-1">Recent Orders</h2>
                <div className="space-y-4">
                    {hires.map((hire) => (
                        <div
                            key={hire.id}
                        ...
                        >
                            <div className="flex items-start justify-between mb-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-red-600 font-black uppercase tracking-widest text-[9px] mt-0.5">
                                            {hire.loadName}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 py-4 border-y border-slate-100 dark:border-white/5">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        <p className="text-[8px] font-black uppercase tracking-widest text-slate-400">Shipped</p>
