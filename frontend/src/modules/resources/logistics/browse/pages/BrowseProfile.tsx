            ...
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <div className="pt-2 flex gap-3">
                ...
                <button
                  type="submit"
                  disabled={isSaving}
                  className="flex-1 py-3 rounded-xl bg-red-600 text-white font-black uppercase tracking-widest text-xs hover:bg-red-700 flex items-center justify-center gap-2 disabled:opacity-50"
                >
        ...
        <div className="bg-white rounded-[3rem] p-8 pt-16 border border-slate-200 text-center shadow-sm">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-0">
            <div className="relative">
              <div className="size-24 rounded-[2rem] bg-red-600 flex items-center justify-center text-white text-3xl font-black shadow-xl border-4 border-slate-50">
                {initials}
              </div>
              <button
          ...
          <p className="text-red-600 font-black uppercase tracking-widest text-[10px] mb-6">
            Logistics Premium Client
          </p>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="bg-slate-50 p-4 rounded-3xl text-center">
              ...
              <p className="text-base font-black italic">{profileAny.ordersCount || 0}</p>
            </div>
            <div className="bg-slate-50 p-4 rounded-3xl text-center">
              <p className="text-[8px] font-black uppercase tracking-widest text-slate-400 mb-0.5">
                Spent
        ...
        <div className="grid gap-3">
          <button className="flex items-center justify-between p-5 bg-white rounded-3xl border border-slate-200 active:scale-[0.98] transition-all group">
            ...
            <div className="flex items-center gap-2">
              ...
              <ChevronRight className="size-5 text-slate-300 group-hover:text-red-600 transition-colors" />
            </div>
          </button>
          ...
          >
            ...
            <Edit3 className="size-5 text-slate-300 group-hover:text-red-600 transition-colors" />
          </button>
        </div>
      </div>
    </div>
