                ...
                <div className="bg-white dark:bg-slate-900/50 rounded-[3rem] p-8 pt-16 border border-slate-200 dark:border-white/10 text-center shadow-sm">
                    ...
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-0">
                        <div className="relative">
                            <div className="size-24 rounded-[2rem] bg-rose-600 flex items-center justify-center text-white text-3xl font-black shadow-xl border-4 border-slate-50 dark:border-background italic">
                                S
                            </div>
                    ...
                    <h2 className="text-2xl font-black tracking-tight leading-tight">SiteGuard Professionals</h2>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8">
                        <div className="bg-slate-50 dark:bg-white/5 p-4 rounded-3xl text-center border border-slate-100 dark:border-white/5">
                            ...
                            <p className="text-base font-black italic">5.0/5</p>
                        </div>
                        <div className="bg-slate-50 dark:bg-white/5 p-4 rounded-3xl text-center border border-slate-100 dark:border-white/5">
                            <p className="text-[8px] font-black uppercase tracking-widest text-slate-400 mb-0.5">Projects</p>
                            <p className="text-base font-black italic">200+</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4 text-left">
                        <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] font-black capitalize">Pune, Maharashtra</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5">
                            <div className="size-10 rounded-xl bg-white dark:bg-slate-900 flex items-center justify-center shadow-sm text-slate-400">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] font-black uppercase tracking-tighter">CSM-PUN-2026-1024</p>
                            </div>
                        </div>
                    </div>
                </div>
