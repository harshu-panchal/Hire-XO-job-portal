          ...
          {recentInquiries.map((inquiry: any) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div
                  className={`size-10 rounded-xl bg-gradient-to-br ${inquiry.color} flex items-center justify-center text-white font-black text-sm shrink-0`}
                >
                  {inquiry.initial}
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`text-[8px] font-black uppercase tracking-widest ${inquiry.status === "New" ? "text-emerald-600" : "text-slate-400"}`}
                    >
