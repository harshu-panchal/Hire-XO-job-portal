        ...
        <div className="py-6 space-y-8 select-none">
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between px-1">
                    <h2 className="text-xl font-black tracking-tight">Client Inquiries</h2>
                    <Link
            ...
            {/* Performance Stats */}
            <div className="bg-gradient-to-br from-rose-600 to-rose-800 rounded-[2.5rem] p-6 text-white shadow-xl shadow-rose-600/20">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-widest opacity-60">Service Performance</p>
                        <h3 className="text-xl font-black tracking-tight">Elite Efficiency</h3>
                    </div>
            ...
            <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                        ...
                        <p className="text-[9px] font-black uppercase tracking-widest text-slate-400">Offer CSM</p>
                    </Link>
                    <Link
                    ...
                    >
                        ...
                        <p className="font-black text-sm">Active Services</p>
                        <p className="text-[9px] font-black uppercase tracking-widest text-slate-400">Manage Listings</p>
                    </Link>
                </div>
            </div>
        </div>
