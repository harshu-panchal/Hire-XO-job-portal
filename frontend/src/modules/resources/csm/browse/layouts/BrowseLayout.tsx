        ...
        <div className="flex justify-between items-center h-20">
          <Link
            ...
            className={`flex flex-col items-center gap-1.5 transition-all duration-200 active:scale-90 ${
              isActive("/csm/browse/dashboard") ? "text-rose-600" : "text-slate-400"
            }`}
          >
            <div
              className={`p-2.5 rounded-2xl transition-all duration-200 ${
                isActive("/csm/browse/dashboard")
                  ? "bg-rose-600/10 scale-110 shadow-lg shadow-rose-600/5"
                  : "bg-transparent"
              }`}
            >
              <LayoutDashboard
                className={`h-6 w-6 ${isActive("/csm/browse/dashboard") ? "fill-rose-600/20" : ""}`}
              />
            </div>
            <span
              className={`text-[10px] font-black uppercase tracking-[0.2em] ${
                isActive("/csm/browse/dashboard") ? "opacity-100" : "opacity-40"
              }`}
            >
              Dash
            </span>
          ...
          <Link
            ...
            className={`flex flex-col items-center gap-1.5 transition-all duration-200 active:scale-90 ${
              isActive("/csm/browse/my-hires") ? "text-rose-600" : "text-slate-400"
            }`}
          >
            <div
              className={`p-2.5 rounded-2xl transition-all duration-200 ${
                isActive("/csm/browse/my-hires")
                  ? "bg-rose-600/10 scale-110 shadow-lg shadow-rose-600/5"
                  : "bg-transparent"
              }`}
            >
              <Briefcase
                className={`h-6 w-6 ${isActive("/csm/browse/my-hires") ? "fill-rose-600/20" : ""}`}
              />
            </div>
            <span
              className={`text-[10px] font-black uppercase tracking-[0.2em] ${
                isActive("/csm/browse/my-hires") ? "opacity-100" : "opacity-40"
              }`}
            >
              Hired
            </span>
          ...
          <Link
            ...
            className={`flex flex-col items-center gap-1.5 transition-all duration-200 active:scale-90 ${
              isActive("/csm/browse/profile") ? "text-rose-600" : "text-slate-400"
            }`}
          >
            <div
              className={`p-2.5 rounded-2xl transition-all duration-200 ${
                isActive("/csm/browse/profile")
                  ? "bg-rose-600/10 scale-110 shadow-lg shadow-rose-600/5"
                  : "bg-transparent"
              }`}
            >
              <User
                className={`h-6 w-6 ${isActive("/csm/browse/profile") ? "fill-rose-600/20" : ""}`}
              />
            </div>
            <span
              className={`text-[10px] font-black uppercase tracking-[0.2em] ${
                isActive("/csm/browse/profile") ? "opacity-100" : "opacity-40"
              }`}
            >
              Me
            </span>
          ...
          <Link
            ...
            className={`flex flex-col items-center gap-1.5 transition-all duration-200 active:scale-90 ${
              isActive("/csm/browse/settings") ? "text-rose-600" : "text-slate-400"
            }`}
          >
            <div
              className={`p-2.5 rounded-2xl transition-all duration-200 ${
                isActive("/csm/browse/settings")
                  ? "bg-rose-600/10 scale-110 shadow-lg shadow-rose-600/5"
                  : "bg-transparent"
              }`}
            >
              <Settings
                className={`h-6 w-6 ${isActive("/csm/browse/settings") ? "fill-rose-600/20" : ""}`}
              />
            </div>
            <span
              className={`text-[10px] font-black uppercase tracking-[0.2em] ${
                isActive("/csm/browse/settings") ? "opacity-100" : "opacity-40"
              }`}
            >
              Setup
            </span>
