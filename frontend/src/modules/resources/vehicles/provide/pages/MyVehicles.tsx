...
import { Eye, MessageSquare, MoreVertical, Edit3, Trash2, Car, X, Copy, Archive, MapPin, Calendar, DollarSign, Users, CheckCircle, Plus } from "lucide-react";
    ...
    const [vehicles, setVehicles] = useState<Vehicle[]>([
        {
            ...
            price: "₹4,500/day",
            description: "Premium electric sedan with autopilot, perfect for business travel and daily commutes. Fully charged and maintained.",
        ...
        },
        {
            ...
            price: "₹1,800/day",
            description: "Reliable commercial vehicle for deliveries and logistics. Well-maintained with regular servicing.",
        ...
        <div className="py-6 space-y-8 select-none">
            ...
            <div className="grid grid-cols-3 gap-4">
                <div className="bg-blue-50 dark:bg-blue-950/20 p-4 rounded-2xl border border-blue-200 dark:border-blue-900">
                    <p className="text-[9px] font-black uppercase tracking-widest text-blue-600 mb-1">Total Vehicles</p>
                ...
                <div className="bg-emerald-50 dark:bg-emerald-950/20 p-4 rounded-2xl border border-emerald-200 dark:border-emerald-900">
                    <p className="text-[9px] font-black uppercase tracking-widest text-emerald-600 mb-1">Total Views</p>
                    <p className="text-2xl font-black text-emerald-600">{vehicles.reduce((sum, v) => sum + v.views, 0)}</p>
                </div>
                <div className="bg-orange-50 dark:bg-orange-950/20 p-4 rounded-2xl border border-orange-200 dark:border-orange-900">
                    <p className="text-[9px] font-black uppercase tracking-widest text-orange-600 mb-1">Total Leads</p>
                    <p className="text-2xl font-black text-orange-600">{vehicles.reduce((sum, v) => sum + v.inquiries, 0)}</p>
                </div>
            </div>
                    ...
                    <div onClick={(e) => e.stopPropagation()} className="bg-white dark:bg-slate-900 rounded-3xl p-6 max-w-2xl w-full border border-slate-200 dark:border-white/10 shadow-2xl max-h-[85vh] overflow-y-auto">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-xs text-slate-500 mt-1">VEH-{selectedVehicle.id.toString().padStart(4, '0')}</p>
                            </div>
                            <button
                        ...
                        <div className="space-y-6">
                            {/* Status Badge */}
                            <div className={`inline-flex px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest ${selectedVehicle.status === "Active"
                                ? "bg-emerald-500/10 text-emerald-600 border border-emerald-500/20"
                                : "bg-amber-500/10 text-amber-600 border border-amber-500/20"
                                }`}>
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-600 dark:text-slate-400">{selectedVehicle.description}</p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 bg-blue-50 dark:bg-blue-950/20 rounded-2xl border border-blue-200 dark:border-blue-900">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <p className="text-xs font-black uppercase tracking-widest text-blue-600">Price</p>
                                    </div>
                                ...
                                <div className="p-4 bg-emerald-50 dark:bg-emerald-950/20 rounded-2xl border border-emerald-200 dark:border-emerald-900">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <p className="text-xs font-black uppercase tracking-widest text-emerald-600">Views</p>
                                    </div>
                                ...
                                <div className="p-4 bg-orange-50 dark:bg-orange-950/20 rounded-2xl border border-orange-200 dark:border-orange-900">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <p className="text-xs font-black uppercase tracking-widest text-orange-600">Inquiries</p>
                                    </div>
                                ...
                                <div className="p-4 bg-purple-50 dark:bg-purple-950/20 rounded-2xl border border-purple-200 dark:border-purple-900">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <p className="text-xs font-black uppercase tracking-widest text-purple-600">Posted</p>
                                    </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-800 rounded-xl">
                                    ...
                                    <div>
                                        <p className="text-xs font-black uppercase tracking-widest text-slate-400">Capacity</p>
                            ...
                            {selectedVehicle.features && selectedVehicle.features.length > 0 && (
                                <div>
                                    <p className="text-xs font-black uppercase tracking-widest text-slate-400 mb-3">Features</p>
                                    <div className="flex flex-wrap gap-2">
                                        {selectedVehicle.features.map((feature, index) => (
                                            <div key={index} className="flex items-center gap-2 px-3 py-2 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-900">
            ...
            {showMenuModal && selectedVehicle && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setShowMenuModal(false)}>
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                ...
                                <div className="flex-1 text-left">
                                    ...
                                    <p className="text-xs text-purple-500">VEH-{selectedVehicle.id.toString().padStart(4, '0')}</p>
                                </div>
                            </button>
