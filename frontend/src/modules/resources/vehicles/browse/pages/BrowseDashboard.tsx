      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <h3 className="font-black text-lg tracking-tight mb-2">Range Rover Sport 2024</h3>
          ...
          >
            ...
            <h3 className="font-black text-lg tracking-tight mb-2">Tata Intra V30 Truck</h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 mb-3 line-clamp-2">
