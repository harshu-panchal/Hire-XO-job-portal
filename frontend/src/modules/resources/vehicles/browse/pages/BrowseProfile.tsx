        ...
        <div className="py-6 space-y-8 select-none">
                ...
                <div className="bg-white dark:bg-slate-900/50 rounded-[3rem] p-8 pt-16 border border-slate-200 dark:border-white/10 text-center shadow-sm">
                    ...
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-0">
                        <div className="relative">
                            <div className="size-24 rounded-[2rem] bg-cyan-600 flex items-center justify-center text-white text-3xl font-black shadow-xl border-4 border-slate-50 dark:border-background italic">
                                JD
                            </div>
                    ...
                    <p className="text-cyan-600 font-black uppercase tracking-widest text-[10px] mb-6">Platinum Rental Member</p>

                    <div className="grid grid-cols-2 gap-4 mb-8">
                        <div className="bg-slate-50 dark:bg-white/5 p-4 rounded-3xl text-center shadow-sm">
                        ...
                        <div className="bg-slate-50 dark:bg-white/5 p-4 rounded-3xl text-center shadow-sm">
                            ...
                            <p className="text-base font-black italic">₹1.2L</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4 text-left">
                        <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] font-black">john.doe@rental.com</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5">
                            <div className="size-10 rounded-xl bg-white dark:bg-slate-900 flex items-center justify-center shadow-sm text-slate-400">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] font-black">+91 91234 56789</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="space-y-4">
                ...
                <div className="grid gap-3">
                    <button className="flex items-center justify-between p-5 bg-white dark:bg-slate-900/50 rounded-3xl border border-slate-200 dark:border-white/10 active:scale-[0.98] transition-all group shadow-sm">
