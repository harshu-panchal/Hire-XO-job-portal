    ...
    <div className="py-6 space-y-8 select-none">
          ...
          <div className="bg-white w-full max-w-lg rounded-[2rem] p-6 shadow-2xl border border-slate-200 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                ...
                className="size-8 rounded-full bg-slate-100 flex items-center justify-center hover:bg-cyan-100 hover:text-cyan-600 transition-colors"
              >
                <X className="size-4" />
              </button>
            </div>
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <div className="pt-2 flex gap-3">
                ...
                <button
                  type="submit"
                  disabled={isSaving}
                  className="flex-1 py-3 rounded-xl bg-cyan-600 text-white font-black uppercase tracking-widest text-xs hover:bg-cyan-700 flex items-center justify-center gap-2 disabled:opacity-50"
                >
        ...
        <div className="bg-white rounded-[3rem] p-8 pt-16 border border-slate-200 text-center shadow-sm">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-0">
            <div className="relative">
              <div className="size-24 rounded-[2rem] bg-cyan-600 flex items-center justify-center text-white text-3xl font-black shadow-xl border-4 border-slate-50 italic">
                {initials}
              </div>
              <button
          ...
          <h2 className="text-2xl font-black tracking-tight">{user.name || "Renter"}</h2>
          <p className="text-cyan-600 font-black uppercase tracking-widest text-[10px] mb-6">
            Platinum Rental Member
          </p>

          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="bg-slate-50 p-4 rounded-3xl text-center shadow-sm">
              <p className="text-[8px] font-black uppercase tracking-widest text-slate-400 mb-0.5">
                Rentals
              </p>
              <p className="text-base font-black italic">{profileAny.rentalsCount || 0}</p>
            </div>
            <div className="bg-slate-50 p-4 rounded-3xl text-center shadow-sm">
              <p className="text-[8px] font-black uppercase tracking-widest text-slate-400 mb-0.5">
                Spent
          ...
          <div className="space-y-4 text-left">
            ...
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
              ...
              <div>
                <p className="text-[8px] font-black uppercase tracking-widest text-slate-400">Mobile Number</p>
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-3">
          <button className="flex items-center justify-between p-5 bg-white rounded-3xl border border-slate-200 active:scale-[0.98] transition-all group shadow-sm">
            <div className="flex items-center gap-4">
              <div className="size-12 rounded-2xl bg-emerald-500/10 text-emerald-600 flex items-center justify-center">
                <ShieldCheck className="size-6" />
              </div>
              <span className="font-black text-sm uppercase tracking-widest">KYC Status</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-black text-emerald-600 uppercase tracking-widest">Verified</span>
              <ChevronRight className="size-5 text-slate-300 group-hover:text-cyan-600 transition-colors" />
            </div>
          </button>

          <button
            onClick={() => setIsEditing(true)}
            className="flex items-center justify-between p-5 bg-white rounded-3xl border border-slate-200 active:scale-[0.98] transition-all group shadow-sm"
          >
            <div className="flex items-center gap-4">
              <div className="size-12 rounded-2xl bg-cyan-500/10 text-cyan-600 flex items-center justify-center">
                <CreditCard className="size-6" />
              </div>
              <span className="font-black text-sm uppercase tracking-widest">Payment Methods</span>
            </div>
            <Edit3 className="size-5 text-slate-300 group-hover:text-cyan-600 transition-colors" />
          </button>
        </div>
      </div>
    </div>
