...
const SettingItem = ({ icon: Icon, label, description, action }: SettingItemProps) => (
  <div className="flex items-center gap-4 p-4 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-white/5 shadow-sm group">
    ...
    <div>
      {action || (
        <ChevronRight className="size-5 text-slate-300 group-hover:text-emerald-600 transition-colors" />
      )}
    </div>
  </div>
);
        ...
        <div className="space-y-3">
          <SettingItem
            ...
            action={
              ...
              >
                <div
                  className={`absolute top-1 size-4 bg-white rounded-full transition-all ${notifications ? "left-7" : "left-1"}`}
                />
              </button>
            }
          />
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <SettingItem
            ...
            description="Manage your cards and transfers"
          />
