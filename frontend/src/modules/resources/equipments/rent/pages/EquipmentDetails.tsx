...
const EquipmentDetails = () => {
  ...
  const equipment = {
    ...
    description:
      "The Cat 320 GC offers you the ideal balance of dependable performance, operator productivity features, and cost savings. It is a reliable, low-cost-per-hour machine for your medium-to heavy-duty applications.",
    specs: [
  ...
  return (
    <div className="py-6 space-y-8 select-none">
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-black tracking-tight px-1 uppercase tracking-widest text-[10px] text-slate-400">
          Rental Includes
        </h2>
