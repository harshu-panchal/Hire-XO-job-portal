...
const SettingItem = ({ icon: Icon, label, description, action }: SettingItemProps) => (
  <div className="flex items-center gap-4 p-4 rounded-3xl bg-white border border-slate-100 shadow-sm group">
    ...
    <div className="flex-1 space-y-0.5 min-w-0">
      ...
      <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 truncate mt-1">
        {description}
      </p>
    </div>
    <div>
  ...
  return (
    <div className="py-6 space-y-8 select-none">
      ...
      <div className="space-y-4">
        <h2 className="px-1 text-xs font-black uppercase tracking-[0.2em] text-blue-600">
          Operations
        </h2>
        <div className="space-y-3">
          <SettingItem
            ...
            action={
              ...
              >
                <div
                  className={`absolute top-1 size-4 bg-white rounded-full transition-all ${alerts ? "left-7" : "left-1"}`}
                />
              </button>
            }
          />
          <SettingItem
            ...
            action={
              ...
              >
                <div
                  className={`absolute top-1 size-4 bg-white rounded-full transition-all ${autoResponse ? "left-7" : "left-1"}`}
                />
              </button>
            }
          />
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <SettingItem
            icon={CreditCard}
            label="Bank Accounts"
            description="Payout and deposit configuration"
          />
          <SettingItem
            icon={Palette}
            label="Branding"
            description="Control how your profile looks"
          />
          <SettingItem
            icon={LifeBuoy}
