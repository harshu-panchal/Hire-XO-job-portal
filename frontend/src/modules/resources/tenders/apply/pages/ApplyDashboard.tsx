    ...
    <div className="py-6 space-y-8 select-none">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between px-1">
          ...
          <Link
            to="/tenders/apply/tenders"
            className="text-xs font-black text-violet-600 uppercase tracking-widest flex items-center gap-1 active:scale-95 transition-transform"
          >
                      ...
                      <p className="text-[12px] font-black">
                        {tender.deadline
                          ...
                          : tender.applicationDeadline
                            ? new Date(tender.applicationDeadline).toLocaleDateString()
                            : "Open"}
                      </p>
                    </div>
                  </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Link
          to="/tenders/apply/tenders"
          className="bg-gradient-to-br from-violet-600 to-purple-700 rounded-[2rem] p-6 text-white active:scale-95 transition-transform shadow-xl shadow-violet-500/20"
        >
