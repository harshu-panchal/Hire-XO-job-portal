...
const initialNotifications: Notification[] = [
    {
        id: 1,
        title: "Tender Update",
        description: "The deadline for NHAI Road Project has been extended to Next Friday.",
        time: "45m ago",
        type: "warning",
        unread: true,
    },
    {
        ...
        description: "Your bid for 'Mumbai Bridge' has been moved to Shortlisted stage.",
        time: "2h ago",
        type: "success",
        unread: true,
    },
    {
        ...
        description: "A new tender matching your category was posted: 'Solar Park EPC'.",
        time: "5h ago",
        type: "info",
        unread: false,
    },
    {
        ...
        description: "Tender participation fee for #9042 successfully processed.",
        time: "1d ago",
        type: "success",
        unread: false,
    }
