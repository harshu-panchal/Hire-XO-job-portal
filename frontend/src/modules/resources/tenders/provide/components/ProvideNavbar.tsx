...
const mockNotifications: Notification[] = [
    {
        id: 1,
        title: "Bid Received",
        description: "A new bid has been submitted for your Mumbai Flyover project.",
        time: "30m ago",
        type: "success",
        icon: CheckCircle,
        unread: true,
    },
    {
        ...
        description: "Your tender for Road Maintenance has been successfully published.",
        time: "2h ago",
        type: "info",
        icon: Info,
        unread: false,
            ...
            <div className="max-w-[430px] mx-auto flex items-center justify-between">
                ...
                <div className="flex items-center gap-3 relative">
                    ...
                    <NotificationDropdown
                        ...
                        viewAllPath="/resources/tenders/provide/notifications"
                    />
                </div>
            </div>
        </nav>
