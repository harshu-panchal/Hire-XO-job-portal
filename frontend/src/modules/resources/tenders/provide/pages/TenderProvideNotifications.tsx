...
const initialNotifications: Notification[] = [
    {
        ...
        description: "A bid of ₹45,00,000 was received for Mumbai Flyover Project.",
        time: "15m ago",
        type: "success",
        unread: true,
    },
    {
        ...
        description: "Your tender for 'Pune Smart City - Phase II' is now live.",
        time: "1h ago",
        type: "info",
        unread: true,
    },
    {
        ...
        description: "Your KYC documents for resource provider have been verified.",
        time: "4h ago",
        type: "success",
        unread: false,
    },
    {
        ...
        description: "There is an update regarding your support ticket #8942.",
        time: "1d ago",
        type: "info",
        unread: false,
    }
...
const TenderProvideNotifications = () => {
        ...
        <div className="pb-32 min-h-screen select-none">
            ...
            <div className="px-5 space-y-4">
                {notifs.map((notif) => (
                    <div
                        key={notif.id}
                        className={`group relative p-5 rounded-[2rem] bg-white dark:bg-slate-900/50 border transition-all ${notif.unread ? "border-primary/20" : "border-slate-100 dark:border-white/5 opacity-80"
                            }`}
                    >
...
export default TenderProvideNotifications;
