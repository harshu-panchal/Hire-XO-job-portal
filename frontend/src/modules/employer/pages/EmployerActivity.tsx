...
const EmployerActivity = () => {
  ...
  return (
    <div className="pb-32 min-h-screen select-none">
      {/* Header */}
      <div className="sticky top-0 bg-slate-50/80 backdrop-blur-md z-20 transition-all">
        <div className="flex items-center justify-between px-5 py-6">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="size-11 flex items-center justify-center rounded-2xl bg-white border border-slate-200 active:scale-90 transition-all shadow-sm text-slate-400"
            >
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 min-w-0 pr-8">
                  <div className="flex items-center gap-2 mb-1">
                    <h3
                      className={`text-sm leading-tight truncate ${notif.unread ? "font-black" : "font-bold text-slate-700"}`}
                    >
                      {notif.title}
                    </h3>
                  </div>
