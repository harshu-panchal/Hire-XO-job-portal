...
import { ChevronRight, Clock, MapPin, DollarSign, Edit, Trash2, Plus, ChevronLeft, MoreVertical } from "lucide-react";
    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center min-h-[50vh]">
                <div className="animate-pulse text-sm font-black uppercase tracking-widest text-slate-400">Loading Jobs...</div>
            </div>
        );
    }
            ...
            <div className="space-y-4 mt-2">
                {jobs.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        <h3 className="text-lg font-black tracking-tight text-slate-900 dark:text-white mb-1">No Active Jobs</h3>
