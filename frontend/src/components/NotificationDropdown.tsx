        ...
        <>
          ...
          >
                ...
                notifications.map((notif) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p
                        className={`text-xs leading-tight mb-1 ${notif.unread ? "font-bold text-slate-900 dark:text-white" : "font-medium text-slate-700 dark:text-white/80"}`}
                      >
                        {notif.title}
                      </p>
                      <p className="text-[10px] leading-relaxed text-slate-500 dark:text-white/50 mb-1 line-clamp-2">
                        {notif.description}
                      </p>
            ...
            <Link
              to={viewAllPath}
              onClick={onClose}
              className="block w-full p-3 text-center text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 dark:text-white/20 border-t border-slate-100 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors"
            >
              View All
            </Link>
          </motion.div>
