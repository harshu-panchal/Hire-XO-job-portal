...
function getResourceRedirectPath(user: any): string {
    ...
    const resourcePaths: Record<string, string> = {
        investor: user.profile?.investorType === "want-to-invest"
            ? "/investor/browse/dashboard"
            : "/investor/seek/dashboard",
        tenders: user.profile?.tenderType === "apply-for-tenders"
            ? "/tenders/apply/dashboard"
            : "/tenders/provide/dashboard",
        equipments: user.profile?.equipmentType === "rent-equipment"
            ? "/equipments/rent/dashboard"
            : "/equipments/provide/dashboard",
        machinery: user.profile?.machineryType === "need-machinery"
            ? "/machinery/buy/dashboard"
            : "/machinery/sell/dashboard",
        pmc: user.profile?.pmcType === "hire-pmc"
            ? "/pmc/browse/dashboard"
            : "/pmc/provide/dashboard",
        csm: user.profile?.csmType === "hire-csm"
            ? "/csm/browse/dashboard"
            : "/csm/provide/dashboard",
        logistics: user.profile?.logisticsType === "need-logistics"
            ? "/logistics/browse/dashboard"
            : "/logistics/provide/dashboard",
        vehicles: user.profile?.vehicleType === "rent-vehicles"
